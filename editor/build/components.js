...
`,o.a.customElements.define("ck-section",Gt);var Kt=n(53),Qt=n.n(Kt),te=n(54),ee=n.n(te),ne=n(55),ie=n.n(ne),oe=n(56),se=n.n(oe);o.a.customElements.define("ck-gallery",class extends jt{static get properties(){return{items:Array,currentItem:{type:Number,attribute:"ck-current-item"},numberOfChildren:{type:Number},maxItems:{type:Number,attribute:"ck-max"},sections:{type:String,attribute:"ck-contains"},controlsPosition:{type:String,attribute:"ck-controls-position"}}}constructor(){super(),this.items=[],this.currentItem=0}validate(){Array.from(this.children).forEach(t=>{t instanceof jt&&t.validate()})}hasError(){return this.items.filter(t=>t.error).length>0}getItems(){return Array.from(this.children).filter(t=>"BR"!==t.nodeName).map((t,e)=>({element:t,error:t instanceof jt&&t.hasError(),title:e+1,index:e}))}connectedCallback(){super.connectedCallback(),this.shadowRoot.addEventListener("slotchange",()=>{this.items=this.getItems(),this.numberOfChildren=this.items.length}),this.maxItems=this.maxItems||0,this.items=this.getItems(),this.numberOfChildren=this.items.length,this.setGalleryItem(this.currentItem),this.addEventListener("ck-editor:element-validation-error",()=>{this.items=this.getItems()}),this.addEventListener("ck-editor:element-validation-error-resolved",()=>{this.items=this.getItems()})}render(){return B`
    ...
    `}appendHandler(t){this.modifyDocument(e=>e.insert(t.detail.section,this,"end")),this.setCurrentTab(Array.from(this.children).length-1)}render(){return B`
      <style>
        ::slotted(*) {
          display: none;
        }
...
`,o.a.customElements.define("ck-button",fe);var ye=n(61),_e=n.n(ye);class xe extends jt{static get properties(){return{label:{type:String},resolved:{type:Boolean},isResolving:{type:Boolean}}}constructor(){super(),this.label=xe.label,this.resolved=!1,this.isResolving=!1}connectedCallback(){super.connectedCallback(),Array.from(this.children).forEach(t=>t.addEventListener("optionSelected",this.selectOptionHandler.bind(this))),document.addEventListener("click",t=>{!this.contains(t.target)&&this.isResolving&&(this.isResolving=!1)})}render(){return B`
    ...
    `}firstUpdated(){"left"===this.position&&(this.style.width="50%",this.shadowRoot.querySelector(".media-conflict-option").style.minWidth=`${2*this.offsetWidth}px`)}optionSelected(){this.dispatchEvent(new CustomEvent("optionSelected",{detail:this.children.item(0)}))}});var He=n(65),Te=n.n(He);const Pe=D`

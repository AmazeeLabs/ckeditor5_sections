...
`;var ue=n(58),me=n.n(ue);class be extends mt{static get properties(){return{from:{type:String},content:{type:String}}}connectedCallback(){super.connectedCallback(),this.content=this.innerHTML}render(){return B`
      <style>
        ${me.a}
      </style>
    ...
    `}optionSelected(){this.dispatchEvent(new CustomEvent("optionSelected",{detail:this.children.item(0)}))}}be.labels={left:"Left version",right:"Right version",source:"Source version",empty:"Clear"},o.a.customElements.define("ck-button-option",be);const ge=D`
<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48">
    <path d="M7.8 24c0-3.42 2.78-6.2 6.2-6.2h8V14h-8C8.48 14 4 18.48 4 24s4.48 10 10 10h8v-3.8h-8c-3.42 0-6.2-2.78-6.2-6.2zm8.2 2h16v-4H16v4zm18-12h-8v3.8h8c3.42 0 6.2 2.78 6.2 6.2s-2.78 6.2-6.2 6.2h-8V34h8c5.52 0 10-4.48 10-10s-4.48-10-10-10z"/>
</svg>
`;class ve extends pe{static get properties(){return{target:{type:String,attribute:"link-target"},error:Boolean,optionsElements:{type:String}}}resolveConflict(){this.isResolving=!0;const t=JSON.parse(this.getAttribute("left")),e=JSON.parse(this.getAttribute("right")),n=JSON.parse(this.getAttribute("source")),i=[];t&&i.push(ve.getItemInfo(t,"left")),e&&i.push(ve.getItemInfo(e,"right")),n&&i.push(ve.getItemInfo(n,"source")),this.optionsElements=i}static getItemInfo(t,e){return{label:e,href:t["link-target"],title:t.title,target:t.target,links:t["data-cta-type"]}}hasConflict(){return this.hasAttribute("left")||this.hasAttribute("source")||this.hasAttribute("right")}render(){const t=this.hasConflict()?this.resolveConflict:this.selectLink;return B`
      <div
    ...
    `}resolved(t){const e=JSON.parse(this.getAttribute(t));this.modifyDocument(t=>{t.attributes(this,{"link-target":e["link-target"]}),t.removeAttribute(this,"left"),t.removeAttribute(this,"right"),t.removeAttribute(this,"source")}),this.isResolving=!1,this.optionsElements=[]}}ve.styles=pt`
  ${pe.styles}
  .button {
    position: relative;
  }
...
`,o.a.customElements.define("ck-button",ve);var fe=n(59),_e=n.n(fe);class ye extends Ut{static get properties(){return{label:{type:String},resolved:{type:Boolean},isResolving:{type:Boolean}}}constructor(){super(),this.label=ye.label,this.resolved=!1,this.isResolving=!1}connectedCallback(){super.connectedCallback(),Array.from(this.children).forEach(t=>t.addEventListener("optionSelected",this.selectOptionHandler.bind(this))),document.addEventListener("click",t=>{!this.contains(t.target)&&this.isResolving&&(this.isResolving=!1)})}render(){return B`
    ...
    `}clickResolvingHandler(){this.isResolving=!0}selectOptionHandler(t){this.resolved=!0,this.isResolving=!1,this.modifyDocument(e=>e.swap(t.detail,this))}}ye.label="Conflict needs resolving";var xe=n(60),ke=n.n(xe);class we extends mt{static get properties(){return{from:{type:String},content:{type:String}}}render(){return B`
      <style>
        ${ke.a}
      </style>
      <div class="option" @click="${this.optionSelected}">
        <span class="option__label"
          >${we.labels[this.from]}</span
        >
        <span class="option__content"><slot></slot></span>
      </div>
    `}optionSelected(){this.dispatchEvent(new CustomEvent("optionSelected",{detail:this.children.item(0)}))}}we.labels={left:"Left version",right:"Right version",source:"Source version",empty:"Clear"},o.a.customElements.define("ck-conflict-text",ye),o.a.customElements.define("ck-conflict-option",we);var Se=n(61),Ee=n.n(Se);class Ce extends Ut{static get properties(){return{from:{type:String}}}connectedCallback(){super.connectedCallback(),Array.from(this.children).forEach(t=>{t.addEventListener("optionSelected",this.selectOptionHandler.bind(this))}),this.children.item(0).setAttribute("position","left"),this.children.item(1).setAttribute("position","right"),this.touchStart=!1,this.addEventListener("mousedown",this.touchStartHandler,!1),this.addEventListener("mouseup",this.touchEndHandler,!1),this.addEventListener("mouseover",this.touchEndHandler,!1),this.addEventListener("mousemove",this.eventHandler,!1),this.addEventListener("touchmove",this.eventHandler,!1)}render(){return B`
      <style>
        ${Ee.a}
      </style>
...
`;o.a.customElements.define("ck-media",class extends Ut{static get properties(){return{loaderIsVisible:Boolean,mediaType:{attribute:"data-media-type",type:String},mediaUuid:{attribute:"data-media-uuid",type:String},mediaDisplay:{attribute:"data-media-display",type:String},enableUpload:{attribute:"ck-upload",type:Boolean},enableEdit:{attribute:"ck-edit",type:Boolean},buttonPosition:{attribute:"ck-button-position",type:String},preview:String,error:Boolean}}validate(){const t=this.error;this.error=!this.mediaUuid,!t&&this.error?this.emitElementValidationErrorEvent("Media is required","media_required"):t&&!this.error&&this.emitElementValidationErrorResolvedEvent()}connectedCallback(){super.connectedCallback(),this.requestInformation("show-errors",{},t=>{t&&this.validate()})}renderPreview(){this.loaderIsVisible=!0,this.requestInformation("media-preview",{type:this.mediaType,uuid:this.mediaUuid,display:this.mediaDisplay},t=>{this.preview=t,this.loaderIsVisible=!1})}updated(t){this.previewPane=this.shadowRoot.querySelector(".ck-media__preview"),t.has("mediaUuid")&&this.mediaUuid&&(this.validate(),this.renderPreview()),t.has("preview")&&this.preview&&(this.previewPane.innerHTML=this.preview)}render(){return B`
    ...
    `}}Ve.initializeWithErrors=!1,o.a.customElements.define("ck-textfield",Ve);var Be=n(65),De=n.n(Be);o.a.customElements.define("ck-collapse",class extends Xt{static get properties(){return{collapseIsOpen:{type:Boolean}}}connectedCallback(){super.connectedCallback(),null==this.collapseIsOpen&&(this.collapseIsOpen=!1)}toggleCollapse(){this.collapseIsOpen=!this.collapseIsOpen}render(){return B`
      <style>
        ${De.a}
      </style>
